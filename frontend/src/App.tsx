...
const MainLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#faf8f4] text-slate-900 selection:bg-[#c29b38] selection:text-white flex">
      ...
      <div className="flex-1 flex flex-col min-w-0 lg:pl-72 transition-all duration-300">
        ...
        {/* Footer */}
        <footer className="bg-[#160e06] text-[#e3cfa1] border-t border-[#c29b38]/25 py-6 mt-12 text-xs">
